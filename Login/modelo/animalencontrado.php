<?php
    ...
    $insertar = mysqli_query($link, "INSERT INTO animales (lugar, raza, fecha, descripcion, tipo_mascota, foto) VALUES ('$lugar', '$raza','$fecha1', '$descripcion', 'encontrado', '$destino')");
    ...
    rename("../imagenesanimales/$destino" , "../imagenesanimales/$fotoid");
        ...
        if($update && $insertar){
            ...
            header("location: ../index.php?page=encontrados");
        }else{
